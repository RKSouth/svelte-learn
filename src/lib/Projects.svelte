<h2>Cool Projects</h2>
<ul>
  <li><strong>Drink to the Weather</strong></li>
  <li>
  ...
  <li>
    <a href="https://github.com/RKSouth/OldSchoolPong">Github Link</a>
    <span> || </span>
    <a href="https://rksouth.github.io/OldSchoolPong/">Live Deployment</a>
  </li>
